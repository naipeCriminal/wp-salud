...
<div class="col-md-6">
	<a href="<?php echo $seccion1_pdf; ?>"><button class="boton-verde"><img class="icon" src="#">Descargar PDF</button></a>
</div>
<div>
</div>
</div>
...
<div class="col-md-6">
	<a href="<?php echo $seccion2_pdf; ?>"><button class="boton-verde"><img class="icon" src="#">Descargar PDF</button>
</div>
</div>
</div>
