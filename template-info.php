			...
			<div class="row">
				<div class="col-md-12" style="width: 100%;margin-bottom: 20px;">
					...
					<div class="col-md-4 col-xs-12 text-center">
						<a target="_BLANK" style="border: 1px solid #006EC1;margin-bottom: 15px;" class="btn btn-default" href="<?php  the_sub_field('filepdf'); ?>"><img class="icon" src="http://ec2-52-213-166-151.eu-west-1.compute.amazonaws.com/wp-content/uploads/2017/02/icn_pdf_blue.png"><?php  the_sub_field('nombre'); ?></a>
					</div>
					<?php
		    		endwhile;
					endif;
